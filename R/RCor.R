...
#' @param method a character string specifying the correlation coefficient to be used for the independence test. Possible values are "tau", "tau_b", "tau_b_mod", "gamma", "rho", "rho_b" and "r". The recommendation for data with ties is "gamma" \insertCite{Goodman1954}{RCor}. Specifying "tau_b_mod" only yields the independence test for IID data.
#' @param IID logical indicator determining whether the inference shall be conducted under iid (default) or time series assumptions (see \insertCite{pohle2025inference}{RCor} for a precise description of the assumptions)
